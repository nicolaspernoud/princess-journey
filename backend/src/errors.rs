...
impl std::fmt::Display for ServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ServerError::DieselNotFound => write!(f, "Object not found"),
...
impl ResponseError for ServerError {
    fn error_response(&self) -> HttpResponse {
        match self {
            ...
            ServerError::DieselNotFound => HttpResponse::NotFound().body("Object not found"),
...
impl From<BlockingError<String>> for ServerError {
    fn from(err: BlockingError<String>) -> ServerError {
