                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: Text(
                        MyLocalizations.of(context)!.journeySoFarDetails(
                          user.daysOfFasting,
                          user.maxDaysOfFasting,
                        ),
                      ),
                    ),
                  ],
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: Text(
                          MyLocalizations.of(context)!.tr("butterfly_princess"),
                        ),
                        subtitle: Text(
                          MyLocalizations.of(
                            context,
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: Text(
                          MyLocalizations.of(
                            context,
                          )!.tr("princess_of_the_wind"),
                        ),
                        subtitle: Text(
                          MyLocalizations.of(
                            context,
                          )!.tr("princess_of_the_wind_details"),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: Text(
                          MyLocalizations.of(
                            context,
                          )!.tr("princess_of_the_forest"),
                        ),
                        subtitle: Text(
                          MyLocalizations.of(
                            context,
                          )!.tr("princess_of_the_forest_details"),
                        ),
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        subtitle: Text(
                          MyLocalizations.of(context)!.tr("not_an_end_details"),
                        ),
                      ),
                    ],
                  ),
